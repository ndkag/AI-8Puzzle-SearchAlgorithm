...
namespace AI_8Puzzle
{
    class State
    {
        ...
        //Đếm ô sai cho 1 trạng thái so với trạng thái đích, chính là giá trị của heuristic 
        ...
        // hàm này để tách từ 1 máng truyền vào theo mỗi bước đi (trái, phải, lên, xuống) sẽ tạo ra bao nhiêu màng nữa
    ...
    class BFS
    {
        ...
        public List<State> Solve()
        {
            ...
            // hàng đợi enqueue thêm vào cuối, và dequeue lãy ra ở đầu và remove luôn ptu đó
            ...
            while (danhSachDinhDuyet.Count > 0)
            {
                ...
                dem++;
                // dòng này để in ra các trạng thái màng đã duyệt dưới dạng ma trận 3x3 //ptLayRa.inRaMotState();
                ...
                foreach (var item in hungPhanTachTrangThai) {
                    ...
                    {
                        Console.WriteLine("Ban da chien thang!.....");
                        //lần vết lúc này sẽ trả về danh sách đường đi nhưng bị ngược => qua nút Giải reverse nó
                        LanVet(ketQua, item);
        ...
        public List<State> Solve_BestFirstSearch()
        {
            ...
            while (danhSachDinhDuyet.Count > 0)
            {
                ...
                // dòng này để in ra các trạng thái màng đã duyệt dưới dạng ma trận 3x3 
                ...
                //ptLayRa dem đã phân tách coi được mấy trạng thái
                List<State> hungPhanTachTrangThai = ptLayRa.PhanTachTrangThai();
                foreach (var item in hungPhanTachTrangThai)
                {
        ...
        //lần vết để đưa mỗi nút cha đã gán trước đó vào trong list kết quả
